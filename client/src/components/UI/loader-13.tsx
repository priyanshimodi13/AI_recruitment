...
// Since we don't have shadcn's cn utility in this exact project structure, we use a simple fallback
      ...
      >
        ...
        >
          ...
          <path
            ...
            style={{ stroke: "rgba(156, 163, 175, 0.5)" }} /* Fallback for stroke-muted */
          />
          {/* Animated path using primary theme color */}
          <path
            style={{ animation: `infinity-loader-travel 2s linear infinite`, stroke: "#3b82f6" }} /* Fallback for stroke-primary */
