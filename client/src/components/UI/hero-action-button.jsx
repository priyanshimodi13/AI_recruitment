...
export const HeroActionButton = ({
    ...
    <>
      ...
      <div className="relative z-10 flex items-center gap-4">
        ...
        <div className="flex-1 text-left">
          <p className="text-white font-bold text-lg group-hover:text-white/90 transition-colors duration-300 drop-shadow-sm leading-tight">
            {title}
          </p>
          {subtitle && (
  ...
  const classes = `group relative overflow-hidden border-2 cursor-pointer transition-all duration-500 ease-out 
