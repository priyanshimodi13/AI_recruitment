...
function LoginPage({ onSubmit, isLoading, error }) {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 dark bg-[var(--color-bg)] text-[var(--color-text)]">
      ...
      {/* Right Login Section */}
      <div className="flex items-center justify-center p-8 bg-[var(--color-bg)]">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2 text-[var(--color-heading)]">Welcome back!</h1>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 bg-[var(--color-bg)] border-[var(--color-border)] focus:border-primary text-[var(--color-text)]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-[var(--color-bg)] border-[var(--color-border)] focus:border-primary text-[var(--color-text)]"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox id="remember" className="border-[var(--color-border)]" />
                <Label
                  htmlFor="remember"
                  className="text-sm font-normal cursor-pointer text-[var(--color-text)]"
                >
            ...
            <Button 
              type="submit" 
              className="w-full h-12 text-base font-bold uppercase tracking-widest bg-[#c8f135] text-black hover:bg-white transition-all duration-300" 
              size="lg" 
              disabled={isLoading}
            >
          ...
          <div className="text-center text-sm text-[var(--color-text-muted)] mt-8">
            ...
            <a href="/sign-up" className="text-[var(--color-text)] font-medium hover:underline">
              Sign Up
            </a>
          </div>
        </div>
