...
const DigitalSerenity = () => {
  ...
  const pageStyles = `
    ...
    .word-animate { display: inline-block; opacity: 0; margin: 0 0.3em !important; transition: color 0.3s ease, transform 0.3s ease; }
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-slate-100 font-primary overflow-hidden relative">
        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-6 py-10 sm:px-8 sm:py-12 md:px-16 md:py-20">
          <div className="text-center">
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              <span className="word-animate" data-delay="0">Stop</span>{' '}
              <span className="word-animate" data-delay="300">wasting</span>{' '}
              <span className="word-animate" data-delay="500">time.</span>
            </h2>
          ...
          <div className="text-center max-w-5xl mx-auto relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-50 text-decoration-animate">
              <div className="mb-4 md:mb-6">
                <span className="word-animate" data-delay="700">"Most</span>{' '}
                <span className="word-animate" data-delay="850">hiring</span>{' '}
                <span className="word-animate" data-delay="1000">teams</span>
              </div>
              {/* Responsive Secondary Heading Sizes & Added tracking-wide for letter spacing */}
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-300 leading-relaxed tracking-wide mt-2">
                <span className="word-animate" data-delay="1400">waste</span>{' '}
                <span className="word-animate" data-delay="1550">60%</span>{' '}
                <span className="word-animate" data-delay="1700">of</span>{' '}
                <span className="word-animate" data-delay="1850">their</span>{' '}
                <span className="word-animate" data-delay="2000">time</span>{' '}
                <span className="word-animate" data-delay="2150">on</span>{' '}
                <span className="word-animate" data-delay="2300">tasks</span>{' '}
                <span className="word-animate" data-delay="2450">a</span>{' '}
                <span className="word-animate" data-delay="2600">machine</span>{' '}
                <span className="word-animate" data-delay="2750">can</span>{' '}
                <span className="word-animate" data-delay="2900">do</span>{' '}
                <span className="word-animate" data-delay="3050">in</span>{' '}
                <span className="word-animate" data-delay="3200">seconds."</span>
              </div>
            </h1>
          ...
          <div className="text-center">
            ...
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              ...
              <span className="word-animate" data-delay="3200">Screen,</span>{' '}
              <span className="word-animate" data-delay="3400">Hire.</span>
            </h2>
