  ...
  return (
    <div className="p-10 rounded-[2.5rem] backdrop-blur-xl bg-black/60 border border-white/10 shadow-2xl">
      <div className="mb-10 text-center">
        <h2 className="text-4xl font-display font-bold mb-3 relative group">
          ...
          <span className="relative inline-block text-white tracking-tighter uppercase">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          ...
          className={`w-full py-4 rounded-xl text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 transform hover:-translate-y-1 active:scale-95 disabled:opacity-50 disabled:transform-none shadow-xl shadow-lime-400/10 ${
            isSuccess
              ? 'bg-white text-black'
      ...
      <div className="mt-10">
        <div className="relative flex items-center justify-center">
          ...
          <div className="bg-[#0c0c0c] px-4 relative text-white/30 text-[10px] font-bold uppercase tracking-[0.3em]">
            Social Access
          </div>
        </div>
      ...
      <p className="mt-10 text-center text-xs font-medium text-white/40">
        New to the vision?{' '}
        <a href="/role-selection?action=signup" className="font-bold text-white hover:text-lime-400 transition-colors uppercase tracking-widest ml-1">
          Join Now
        </a>
      </p>
    </div>
