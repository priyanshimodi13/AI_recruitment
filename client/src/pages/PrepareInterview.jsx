...
export default function PrepareInterview() {
  return (
    <div className="pt-20">
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl lg:text-7xl font-display font-bold leading-tight text-[var(--color-heading)] italic">
          ...
          <div className="relative group">
            ...
            <div className="relative glass border-[var(--color-border)] rounded-3xl overflow-hidden shadow-2xl p-4 bg-[var(--color-surface)]">
              <div className="aspect-video bg-black/5 rounded-2xl relative overflow-hidden flex items-center justify-center border border-[var(--color-border)]">
                <div className="absolute top-4 left-4 flex gap-2">
                  ...
                  <div className="px-2 py-1 rounded-md bg-[var(--color-surface)] text-[var(--color-heading)] text-[8px] font-bold font-mono border border-[var(--color-border)] italic">00:42:12</div>
                </div>
                <div className="text-center space-y-4">
                   <div className="w-16 h-16 rounded-full bg-[var(--color-accent)]/20 flex items-center justify-center mx-auto border border-[var(--color-accent)]/40 ring-4 ring-black/5">
                      <Mic className="w-8 h-8 text-[var(--color-accent)]" />
                   </div>
                   <p className="text-xs text-[var(--color-text-muted)] italic">"Can you explain your approach to managing conflict in a high-stakes environment?"</p>
                </div>
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                   ...
                   <div className="text-[9px] text-[var(--color-text-muted)] font-mono tracking-tighter p-1 bg-[var(--color-surface)] border border-[var(--color-border)] rounded italic">@AI_INTERVIEW_SENTIMENT</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 2. PROBLEM SECTION */}
      <section className="py-24 px-6 border-y border-[var(--color-border)] bg-[var(--color-surface-2)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto space-y-6 mb-20">
            <h2 className="text-3xl font-display font-bold text-[var(--color-heading)] italic">Why Interviewing is Hard</h2>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="text-center space-y-4">
                 <div className="w-16 h-16 bg-[var(--color-surface)] rounded-full flex items-center justify-center mx-auto border border-[var(--color-border)] group hover:border-[var(--color-accent)] transition-all">
                    <p.icon className="w-8 h-8 text-[var(--color-accent)]" />
                 </div>
                 <h3 className="text-lg font-bold text-[var(--color-heading)] tracking-widest uppercase italic">{p.title}</h3>
                 <p className="text-sm text-[var(--color-text-muted)] leading-relaxed max-w-xs mx-auto">{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <GlowCard 
                  ...
                  glowColor="blue" 
                  customSize={true} 
                  className="group block bg-[var(--color-surface)] border border-[var(--color-border)]/50 !shadow-sm hover:!shadow-md transition-shadow"
                >
                   <div className="flex flex-col h-full">
                     <div className="w-10 h-10 bg-[var(--color-accent)]/5 rounded-lg flex items-center justify-center mb-6 border border-[var(--color-border)] group-hover:border-[var(--color-accent)]/30 transition-colors">
                        <c.icon className="w-5 h-5 text-[var(--color-accent)]" />
                     </div>
                     <h4 className="text-[var(--color-heading)] font-bold mb-2 tracking-tight uppercase italic text-sm">{c.title}</h4>
           ...
           <div className="space-y-10">
              <h2 className="text-4xl lg:text-5xl font-display font-bold text-[var(--color-heading)] leading-tight italic">
              ...
              <div className="space-y-6">
                 {[
                   ...
                   <div key={i} className="flex gap-4 items-center">
                      ...
                      <span className="text-[var(--color-text)] font-medium tracking-tight text-lg italic">{t}</span>
                   </div>
                 ))}
              </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto glass rounded-[40px] p-16 text-center border-[var(--color-border)] bg-[var(--color-surface)] shadow-xl space-y-8 relative group overflow-hidden">
           ...
           <h2 className="text-3xl lg:text-5xl font-display font-bold text-[var(--color-heading)] leading-tight italic relative z-10">
           ...
           <p className="text-lg text-[var(--color-text-muted)] max-w-xl mx-auto italic relative z-10">
              HireVision gives you the confidence and the data to land the role you deserve.
           </p>
