...
export default function RoleSelectionPage() {
 ...
 return (
  ...
  >
   <ThreeBackground />
   <div className="absolute inset-0 bg-gradient-to-br from-lime-400/5 to-transparent pointer-events-none"></div>
   
   <div className="w-full max-w-4xl relative z-20 px-6">
    <div className="text-center mb-12" ref={titleRef}>
     <h1 className="text-white font-display font-bold tracking-tighter text-4xl md:text-6xl mb-4">
      CHOOSE YOUR PATH
     </h1>
    ...
    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto" ref={cardsRef}>
     ...
     >
      ...
      <div className="relative z-10 flex flex-col h-full">
       ...
       <h2 className="text-4xl font-display font-bold text-white mb-6 tracking-tight uppercase">FIND A JOB</h2>
       ...
       <div className="text-[11px] font-bold uppercase tracking-[0.2em] text-lime-400 flex items-center gap-2 group-hover:gap-4 transition-all duration-300">
     ...
     >
      ...
      <div className="relative z-10 flex flex-col h-full">
       ...
       <h2 className="text-4xl font-display font-bold text-white mb-6 tracking-tight uppercase">POST A JOB</h2>
       <p className="text-slate-400 font-medium leading-relaxed mb-10 flex-grow text-[15px]">
